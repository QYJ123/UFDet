...
#hrsc dataset
image_file_path = r'/home/yajun/CX/Pycharm/mmdet_add/my_obb/data/hrsc/Test/AllImages/' #需要加载的测试图片的文件路径


save_file_path = r'./test_img/save_imgs/ufdet/hrsc101_mstest/' #保存测试图片的路径
config_file = r'./configs/obb/my_improve3/1-ORCNN_pr_r101_hrsc_ms.py' #网络模型
checkpoint_file = r'./work_dirs/1-ORCNN_pr_r101_hrsc_ms0/epoch_24.pth'  #训练好的模型参数


split = './BboxToolkit/tools/split_configs/hrsc2016/ms_test.json'
