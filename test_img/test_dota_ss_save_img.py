...
import time
image_file_path = r'./data/split_ss_dota1_0/test/images/' #需要加载的测试图片的文件路径

save_file_path = r'./test_img/save_imgs/rpgaod/dota50_sstest/' #保存测试图片的路径
config_file = r'./work_dirs/0-new/SR2_ORCNN_r50_dota10/SR2_ORCNN_r50_dota10.py' #网络模型
checkpoint_file = r'./work_dirs/0-new/SR2_ORCNN_r50_dota10/epoch_12.pth'  #训练好的模型参数
