...
class OBBSharedWeight2FCBBoxHead(OBBoxHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(OBBSharedWeight2FCBBoxHead, self).__init__(*args, **kwargs)
    ...
    def init_weights(self):
        super(OBBSharedWeight2FCBBoxHead, self).init_weights()
